...
Інтерактивний навчальний портал для груп АР-25ск-1, 175-24-1, 174-24-1. Побудований на React + Vite, за тим самим форматом, що й портали [«Програмування промислових інтерфейсів»](https://github.com/alikxus/promyslovi-interfeysy-portal) та [«Інформаційні системи обліку енергії»](https://github.com/alikxus/energo-oblik-kurs).
